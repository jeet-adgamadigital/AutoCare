...
fun VehicleEditMode(
    ...
    Box(
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            Row(
                ...
                Icon(
                    ...
                    modifier = Modifier
                        .clickable {
                            viewModel.changeCurrentId(null)
                            ...
                            Button(
                                onClick = {
                                    if (vehicleName.isNotBlank() && vehicleNumber.isNotBlank()) {
                                        viewModel.updateVehicle(vehicle, context)
                                    }
                                },
                                modifier = Modifier
                                    .fillMaxWidth()
        ...
        FloatingActionButton(
            onClick = { viewModel.changeState(HomeViewModel.HomeUiStates.AddLogsMode(vehicle.vehicleId)) },
            ...
            Icon(imageVector = Icons.Default.Add, contentDescription = "Add Log Entry")
        }
    }
}